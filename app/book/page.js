...
export const metadata = {
  ...
  description:
    "Book a free 45-minute discovery call with Bradley de Wet. We will look at your current revenue engine, identify friction points, and determine whether this is the right fit.",
  alternates: {
