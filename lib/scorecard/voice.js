 ...
 * of the AI-writing tell this rewrite removed. They now run 3, 5, 4 and 5
 * sentences and 81, 69, 54 and 70 words, and each closes on a mechanic or a
...
export const FIX_PARAGRAPHS = {
  ...
  retention: sanitizeVoice('Retention gaps usually start at the front door. Pull the last ten lost accounts and code the real reason against the qualification criteria each one passed on the way in. Fix the criteria, then fix the first thirty days. Renewal is a lagging number, so give it two quarters before you judge the change.'),
