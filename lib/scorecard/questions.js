...
export const QUESTIONS = [
  ...
  },
  {
    ...
    ...maturity(
      ...
      'Most {model_label} pipelines we see fail here: stage names exist, exit criteria do not.',
      [
  ...
  },
  {
    ...
    ...maturity(
      ...
      'We are listening for whether your numbers are trusted enough to argue from.',
      [
  ...
  },
  {
    ...
    ...maturity(
      ...
      'This is the single most common alignment debate we see in {model_label} businesses.',
      [
  ...
  },
  {
    ...
    ...maturity(
      ...
      'Most {model_label} teams we talk to believe they lose on price. The data usually says otherwise.',
      [
