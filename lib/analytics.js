...
// `home_hero` and `watch_hero`. It was `home_mid_page` until 2026-09-01, when
// the player moved from mid-page into the homepage hero (board item
// web-personality-design). A saved GA4 report filtered on `home_mid_page` now
// returns nothing; that is the move, not a broken tag.
//
