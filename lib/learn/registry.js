...
export const LEARN_PAGES = {
  "revenue-operations-maturity-stage-1-reactive": {
    ...
    ctaUrl:
      "https://modernbizops.com/playbook?utm_source=website_modernbizops&utm_medium=internal&utm_campaign=evergreen_pseo&utm_content=mid_cta_stage1_reactive_hub_v1",
    definedTermSet: {
  ...
  "crm-architecture-and-governance": {
    ...
    ctaUrl:
      "https://modernbizops.com/scorecard?utm_source=website_modernbizops&utm_medium=internal&utm_campaign=evergreen_pseo&utm_content=mid_cta_crm_architecture_and_governance_v1",
    definedTerm: {
  ...
  "pipeline-stage-design": {
    ...
    ctaButtonLabel: "Get Your Revenue Growth Scorecard",
    ctaUrl:
      "https://modernbizops.com/scorecard?utm_source=website_modernbizops&utm_medium=internal&utm_campaign=evergreen_pseo&utm_content=mid_cta_pipeline_stage_design_v1",
    definedTerm: {
