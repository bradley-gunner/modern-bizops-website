...
const VISUALS = {
  ...
  "net-revenue-retention": {
    kicker: "GTM Maturity Framework · Stage 3",
  ...
  "customer-retention-strategy": {
    kicker: "GTM Maturity Framework · Retention",
    accentWord: "Retention",
    motif: "retentionExpansion",
    theme: "teal",
  },
  ...
  "payment-recovery": {
    kicker: "GTM Maturity Framework · Subscription and MRR Operations",
    accentWord: "Recovery",
    motif: "recoveryLoop",
    theme: "teal",
  },
  "customer-lifecycle-marketing": {
    kicker: "GTM Maturity Framework · Revenue Lifecycle",
    accentWord: "Lifecycle",
    motif: "lifecycleLoop",
    theme: "navy",
  },
  "conversion-rate-optimization": {
    kicker: "GTM Maturity Framework · Pipeline and Conversion",
    accentWord: "Conversion",
    motif: "qualifyFunnel",
    theme: "teal",
  },
  // Step-15 AEO batch (2026-08-26): the three buying-decision assets targeting
  // the validated category nouns (ai automation agency cost, consultant vs.
  // in-house, best agencies). New index group "Buying AI Automation"
  // (registered in app/learn/page.js); theme continues the strict rotation
  // from conversion-rate-optimization (teal): navy, teal, navy.
  "ai-automation-agency-cost": {
    kicker: "Buying AI Automation · Cost",
    accentWord: "cost",
    motif: "amplifier",
    theme: "navy",
  },
  "ai-consultant-vs-in-house": {
    kicker: "Buying AI Automation · Consultant vs. In-House",
    accentWord: "decide",
    motif: "fourPaths",
    theme: "teal",
  },
  "best-ai-automation-agencies-b2b": {
    kicker: "Buying AI Automation · The Shortlist",
    accentWord: "best",
    motif: "amplifier",
    theme: "navy",
  },
  // AEO batch 2 (2026-09-01): the pricing cluster. Four pages that feed the
  // queries the 2026-08-30 engine brief found in strike range (readiness
  // assessment, consultant cost, services pricing by item, consultant vs.
  // agency). Same index group; theme continues the strict rotation from
  // best-ai-automation-agencies-b2b (navy): teal, navy, teal, navy. The
  // readiness page borrows the audit page's dataIntegrityGrid (it explains the
  // diagnosis that page sells); the two cost pages keep the cluster's
  // amplifier; the consultant-vs-agency page reuses fourPaths, whose caption
  // ("one stays in the building") is the page's closing argument: the third
  // structure keeps the working knowledge of your systems inside the business.
  "what-is-an-ai-readiness-assessment": {
    kicker: "Buying AI Automation · Readiness Assessment",
    accentWord: "readiness",
    motif: "dataIntegrityGrid",
    theme: "teal",
  },
  "ai-consultant-cost": {
    kicker: "Buying AI Automation · Consultant Cost",
    accentWord: "cost",
    motif: "amplifier",
    theme: "navy",
  },
  "ai-automation-services-pricing": {
    kicker: "Buying AI Automation · Services Pricing",
    accentWord: "cost",
    motif: "amplifier",
    theme: "teal",
  },
  "ai-consultant-vs-ai-agency": {
    kicker: "Buying AI Automation · Consultant vs. Agency",
    accentWord: "agency",
    motif: "fourPaths",
    theme: "navy",
  },
...
const PAGES = {
  "revenue-operations-maturity-stage-1-reactive": {
    ...
    breadcrumb: [
      ...
      { name: "GTM Maturity Framework", url: MODEL_URL },
    ...
    ctaText:
      "Want to know exactly which stage you are in and which two or three competencies are actually holding you back? Take the five-minute AI Revenue Scan.",
  ...
  "fractional-coo": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Most commonly B2B companies roughly between $1M and $50M in revenue, at the stage where the founder is still the de facto head of operations and it has become the constraint on growth. The business model matters less than the situation: agencies, service firms, software companies, and gyms all hit the same wall, where every new dollar of growth requires more of the founder's personal attention.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "It depends almost entirely on your business model. Private B2B SaaS companies report a median around $130,000 per employee; professional services firms typically run $150,000 to $300,000; retail runs far lower. The cross-industry average of roughly $350,000 is skewed by capital-intensive sectors and is not a realistic target for a B2B company. Benchmark against your own model and your own trend, not against a blended average.",
      },
      {
      ...
      },
      {
        ...
        a: "For most B2B companies, yes, comfortably above typical. It is around the top of the professional services range and more than double the private SaaS median. Whether it is good for you depends on your model and your margins: $300,000 per employee with healthy gross margin is an efficient machine, while the same number achieved by running a skeleton crew at the edge of burnout is a risk, not an achievement.",
      },
    ],
    ctaText:
      "The AI Revenue Scan puts this exact number on your business, benchmarks it against named public data for your business model, and shows the dollar gap between you and peer efficiency. Five minutes, sixteen questions.",
    ctaButtonLabel: "Get the Free Scan",
    ctaUrl: "/scorecard",
    // Article, not DefinedTerm: this is an AEO/keyword pillar page (per the
    // keyword-research plan), not a glossary term in the maturity framework. The
  ...
  "smarketing": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Informally, someone who works across both functions or is measured on both outcomes. In practice, B2B companies rarely need a person with the title; they need both existing teams bound to one definition and one scoreboard. The role matters less than the rules.",
      },
      {
  ...
  "mql-to-sql-conversion-rate": {
    ...
    ctaText:
      "The handoff this page describes is one of the competencies the five-minute AI Revenue Scan measures. Find out where your funnel actually leaks between marketing and sales.",
    ctaButtonLabel: "Get the Free Scan",
    ctaUrl: "/scorecard",
  },
  ...
  "win-loss-analysis": {
    ...
    faq: [
      {
        ...
        a: "Start with your own data: pull the last quarter's closed deals and code each with a specific reason, not an outcome. Then interview a balanced sample of the buyers themselves, five wins and five losses is plenty at your deal volume, using open questions about the alternatives they weighed and where their confidence moved. Aggregate quarterly, look for themes rather than anecdotes, and change one concrete thing (a qualification criterion, a stage definition, a piece of positioning) per cycle.",
      },
      {
    ...
    ctaText:
      "The qualification, pipeline, and analysis competencies this page draws on are all measured by the five-minute AI Revenue Scan. Find out which one is your bottleneck right now.",
    ctaButtonLabel: "Get the Free Scan",
    ctaUrl: "/scorecard",
    // Article, not DefinedTerm: this is an AEO/keyword pillar page (per the
    // keyword-research plan), not a glossary term in the maturity framework. The
  ...
  "customer-retention-strategy": {
    ...
    metaDescription:
      "A B2B customer retention strategy, built as a revenue system, not a loyalty program. How to measure it, where the leaks are, and what to fix first.",
    ...
    faq: [
      {
        ...
        a: "It is the observation that a minority of your customers, often around 20%, generate the majority of your revenue and nearly all of your profit. For retention, the rule is not trivia, it is where the strategy starts: segment your accounts by what they are actually worth, then put your real relationship effort, your named owners, and your scheduled reviews on the accounts that carry the company. Treating a $2,000 account and a $200,000 account with the same playbook is how B2B businesses end up overserving customers who will never grow and underserving the ones who pay the bills.",
      },
      {
  ...
  "reduce-customer-churn": {
    ...
    ctaText:
      "If you want help building the early-warning system and fixing the root causes instead of reading about them, book a free discovery call. We build it as a named system, hand over the runbook, and train an internal owner to run it.",
  ...
  "payment-recovery": {
    ...
    metaDescription:
      "Payment recovery for B2B: the difference between dunning and debt collection, what your billing platform already does, and when recovery software is actually worth it.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Dunning recovers a payment that failed for a mechanical reason from a customer who still wants the service, an expired card, a bank decline, a routine glitch. It is fast, automated, and friendly, because the customer never chose to stop paying. Debt collection is the later, more formal, more adversarial process for money that has become genuinely delinquent, often after the relationship has broken down. Confusing the two leads B2B businesses to buy heavyweight collections software for what is really a settings problem in their billing platform.",
      },
      {
    ...
    ctaText:
      "If you want the failed-payment leak measured and the whole billing-recovery system built the right way, book a free discovery call. We build it, hand over the runbook, and train an internal owner so it keeps running without us.",
    ctaButtonLabel: "Book a Free Discovery Call",
    ctaUrl: "/book",
  },
  ...
  "customer-lifecycle-marketing": {
    ...
    metaDescription:
      "Customer lifecycle marketing for B2B is not ecommerce email flows. It is the post-sale revenue engine: onboarding to value, expansion, renewal, and advocacy.",
  ...
  "conversion-rate-optimization": {
    ...
    metaDescription:
      "Conversion rate optimization for B2B is a pipeline problem, not a landing-page problem. Where your real conversion leaks are, and how to fix them for good.",
    ...
    faq: [
      {
        ...
        a: "Stop treating conversion as one number. Break your funnel into its separate rates: speed-to-lead, lead-to-opportunity, opportunity-to-proposal, proposal-to-close. Measure each, find the handoff losing the most interested buyers, and fix that one. For most B2B companies the biggest, cheapest win is speed to lead (contacting a new lead within an hour instead of a day), followed by getting marketing and sales onto one definition of a qualified lead. Landing-page testing comes last, not first, because it optimizes the smallest step while the large leaks sit upstream in the pipeline.",
      },
      {
      ...
      },
      {
        ...
        a: "Website-focused CRO agencies typically run monthly retainers, and specialist consultants charge hourly or by project, all aimed at testing your pages. For a B2B company, that spend often optimizes the wrong end of the funnel. The higher-return path is usually not hiring someone to run tests on your behalf, it is fixing the pipeline handoffs where deals actually leak and building the process so it holds. That is building the fix as a named system your team owns, with a runbook and a trained internal owner, not paying an agency to rent you one. If that is the version you want, the cost conversation starts with a free discovery call.",
      },
    ],
    ctaText:
      "If your leads are converting worse than they should and you want to find the leak that is actually costing you, book a free discovery call. We build the fix as a named system, hand over the runbook, and train an internal owner so the improvement stays.",
    ctaButtonLabel: "Book a Free Discovery Call",
    ctaUrl: "/book",
  },

  // ---- Step-15 AEO batch: the buying-decision cluster ---------------------
  // Three Article pages published 2026-08-26 from the approved step-15 drafts
  // (Marketing Systems/SEO Pilot/pending-approval/aeo-1..3). They target the
  // validated new-noun demand (ai automation agency and its cost/comparison
  // variants) and exist to be the cited answer when an AI assistant is asked
  // what this work costs, whether to hire, and who to hire. They cross-link as
  // a cluster: cost guide <-> decision guide <-> listicle. FAQ answers carry
  // the internal links via aLinks, same mechanism as marketing-and-sales-
  // alignment, so the plain string stays the FAQPage JSON-LD source of truth.
  "ai-automation-agency-cost": {
    slug: "ai-automation-agency-cost",
    pageType: "article",
    // The draft's title tag ran 61 characters ("... Cost? Real 2026 Numbers"),
    // one past the 60-character bound the handoff rules set, so the year moved
    // into the question and the trailing clause came off: 51 characters,
    // flagged in the deploy receipt. The meta is the draft's 199-character
    // string cut to 158 by dropping its middle clause; every surviving word is
    // the draft's.
    title: "How Much Does an AI Automation Agency Cost in 2026?",
    subhead: "Real numbers, and the questions that expose a padded quote",
    metaDescription:
      "AI automation agency pricing in 2026: what projects, retainers, and audits actually cost, and the questions that expose a padded quote. With published prices.",
    url: "https://modernbizops.com/learn/ai-automation-agency-cost",
    ogImage:
      "https://modernbizops.com/og/og-learn-ai-automation-agency-cost.png",
    lastUpdated: "2026-08-26",
    h1: "How much does an AI automation agency cost?",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
      {
        name: "How much does an AI automation agency cost?",
        url: "https://modernbizops.com/learn/ai-automation-agency-cost",
      },
    ],
    faq: [
      {
        q: "Is a $500 AI automation real?",
        a: "Sometimes, as a template installed into your account. Templates are fine for simple, single-tool tasks. They come with no integration work, no data cleanup, and no adoption help, which is why they are $500.",
      },
      {
        q: "Why do so few agencies publish prices?",
        a: "Custom-scope habits, and because unpublished prices can flex per buyer. Published prices are a constraint on the seller, which is exactly why buyers should prefer them.",
      },
      {
        q: "Should I hire instead?",
        a: "At sustained high volume of automation work, yes, and we say so. An operations or GTM engineering hire runs $120K to $160K loaded. The agency route wins when you need three to five systems built and maintained, not a full-time seat. See our guide on that decision: AI consultant vs. in-house.",
        aLinks: [
          {
            text: "AI consultant vs. in-house",
            href: "/learn/ai-consultant-vs-in-house",
          },
        ],
      },
      {
        q: "What about AI usage costs?",
        a: "API and tool costs on a well-scoped business automation typically run a small fraction of the build price. If ongoing usage costs rival the build cost, the scope was wrong.",
      },
    ],
    ctaText:
      "The honest first step is free. The AI Revenue Scan reads where your operations stand in about 5 minutes, before anyone quotes you a build.",
    ctaButtonLabel: "Get the Free Scan",
    ctaUrl: "/scorecard",
  },
  ...
  "ai-consultant-vs-in-house": {
    ...
    pageType: "article",
    title: "AI Consultant vs. In-House: How to Actually Decide in 2026",
    subhead: "The real costs of each path, and the option most comparisons leave out",
    metaDescription:
      "Hire an AI consultant, build in-house, or neither? The real costs of each path, the four-question decision test, and the option most comparisons leave out.",
    url: "https://modernbizops.com/learn/ai-consultant-vs-in-house",
    ogImage:
      "https://modernbizops.com/og/og-learn-ai-consultant-vs-in-house.png",
    lastUpdated: "2026-08-26",
    h1: "AI consultant vs. in-house: how to actually decide",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
      {
        name: "AI consultant vs. in-house: how to actually decide",
        url: "https://modernbizops.com/learn/ai-consultant-vs-in-house",
      },
    ],
    faq: [
      {
        q: "Can I start with a consultant and move in-house later?",
        a: "That is the expected path, done right. Insist on runbooks and internal ownership from build one, and the eventual hire inherits a documented system.",
      },
      {
        q: "How do I know if my foundation is ready?",
        a: "Measurable signals: CRM required-field completeness, duplicate counts, whether marketing and sales share one written definition of a qualified lead. Our $2,500 audit computes this from your actual stack and returns a prioritized map with fixed prices; the fee credits toward your first build within 90 days.",
      },
      {
        q: "What about no-code tools and doing it ourselves?",
        a: "Legitimate for single-tool, single-decision automations. The ceiling arrives at cross-system work (CRM to billing to scheduling), where integration and data-state problems dominate, and at monitoring, which nobody does for automations they built on a Saturday.",
      },
    ],
    ctaText:
  ...
  "best-ai-automation-agencies-b2b": {
    slug: "best-ai-automation-agencies-b2b",
    pageType: "article",
    title: "Best AI Automation Agencies for B2B in 2026 (Ranked)",
    subhead:
      "Ranked by what each firm is actually best at, with prices where they publish them",
    metaDescription:
      "The best AI automation agencies for B2B in 2026, ranked by what each firm is actually best at, with prices where they publish them. We are on the list.",
    url: "https://modernbizops.com/learn/best-ai-automation-agencies-b2b",
    ogImage:
      "https://modernbizops.com/og/og-learn-best-ai-automation-agencies-b2b.png",
    lastUpdated: "2026-08-26",
    h1: "The best AI automation agencies for B2B in 2026",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
      {
        name: "The best AI automation agencies for B2B in 2026",
        url: "https://modernbizops.com/learn/best-ai-automation-agencies-b2b",
      },
    ],
    faq: [
      {
        q: "Are these the biggest AI automation agencies?",
        a: "No, and that is deliberate. Biggest and best-for-you are different lists. This one ranks fit: what each firm is demonstrably best at, for a B2B buyer between roughly $1M and $50M.",
      },
      {
        q: "Why should we trust a list you put yourselves on?",
        a: "You should trust it exactly as far as the disclosure and the specifics let you. Every entry says what the firm is best at and where the fit ends, including ours. The alternative lists are written by content teams that have never bought an automation.",
      },
      {
        q: "What does an AI automation agency cost?",
        a: "Fixed projects roughly $2,000 to $25,000 per system, retainers roughly $1,500 to $10,000 a month. Full breakdown, pricing models, and the questions that expose a padded quote: our AI automation agency cost guide.",
        aLinks: [
          {
            text: "AI automation agency cost guide",
            href: "/learn/ai-automation-agency-cost",
          },
        ],
      },
      {
        q: "Should we hire in-house instead?",
        a: "At sustained, cross-department automation volume, yes. The decision test: AI consultant vs. in-house.",
        aLinks: [
          {
            text: "AI consultant vs. in-house",
            href: "/learn/ai-consultant-vs-in-house",
    ...
    ctaText:
      "The test that matters more than any ranking starts free. The AI Revenue Scan reads whether your operations can support automation at all, in about 5 minutes.",
    ctaButtonLabel: "Get the Free Scan",
    ctaUrl: "/scorecard",
  },

  // ---- AEO batch 2: the pricing cluster -----------------------------------
  // Four Article pages published 2026-09-01 from the approved batch 2 drafts
  // (Marketing Systems/SEO Pilot/pending-approval/aeo-4..7). They feed the
  // pricing queries the 2026-08-30 engine brief found sitting at positions
  // 41-66 (readiness assessment, consultant cost, services pricing by item,
  // consultant vs. agency), and they interlink with the three step-15 pages
  // so the cluster reads as one topic. CTAs follow the search intent, not the
  // funnel stage (Bradley, 2026-09-01): the readiness explainer offers the
  // free Scan, the three pricing pages offer the call that produces a quote.
  // Do not flip them at build time.
  "what-is-an-ai-readiness-assessment": {
    slug: "what-is-an-ai-readiness-assessment",
    pageType: "article",
    // Deliberately not /learn/ai-readiness-assessment, which would collide
    // with the root money page this one links down to.
    title: "AI Readiness Assessment: What It Measures and What It Costs",
    subhead: "What it measures and what it costs",
    metaDescription:
      "What an AI readiness assessment actually measures, what one costs in 2026, what a good one hands you at the end, and why most of them stop at a questionnaire.",
    url: "https://modernbizops.com/learn/what-is-an-ai-readiness-assessment",
    ogImage:
      "https://modernbizops.com/og/og-learn-what-is-an-ai-readiness-assessment.png",
    lastUpdated: "2026-09-01",
    h1: "What is an AI readiness assessment?",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
    ...
    faq: [
      {
        q: "What is meant by AI readiness?",
        a: "Whether your business can get real value from AI given the current state of its data, systems, processes, and team, measured before money gets spent on implementation. It is a property of your operations, not of the AI.",
      },
      {
        q: "How do you measure AI readiness?",
        a: "Two ways. Questionnaires ask you to self-report, which measures perception. Connected assessments read your actual systems and compute the answer from real records, which measures the thing itself. Prefer the second wherever the price allows.",
      },
      {
        q: "What are the pillars of AI readiness?",
        a: "Enterprise frameworks name five to seven: strategy, data, governance, technology, culture, and security among them. For a small or mid-sized B2B company the working set is five: data quality, system connections, process definition, ownership, and what your team already does with AI daily.",
      },
      {
        q: "What does an AI readiness assessment cost?",
        a: "Free for self-serve questionnaires, $1,000 to $5,000 for consultant-led versions worth the name, $10,000 and up at enterprise scope. Ours is $2,500, published, and credits fully toward the first build within 90 days.",
      },
    ],
    ctaText:
  ...
  "ai-consultant-cost": {
    slug: "ai-consultant-cost",
    pageType: "article",
    title: "How Much Does an AI Consultant Cost? Real 2026 Rates",
    subhead: "Real 2026 rates",
    metaDescription:
      "AI consultant costs in 2026: real hourly rates, project prices, and retainers, plus the questions that expose a padded quote. With published prices.",
    url: "https://modernbizops.com/learn/ai-consultant-cost",
    ogImage: "https://modernbizops.com/og/og-learn-ai-consultant-cost.png",
    lastUpdated: "2026-09-01",
    h1: "How much does an AI consultant cost?",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
      {
        name: "How much does an AI consultant cost?",
        url: "https://modernbizops.com/learn/ai-consultant-cost",
      },
    ],
    faq: [
      {
        ...
        a: "Three different jobs sold under one title: advises on strategy and use cases, builds working automations, or sits inside your team as a contract seat. Ask which one you are buying before you compare prices, because each has a different fair pricing model.",
      },
      {
        q: "Is $100 an hour good for consulting?",
        a: "For AI work, $100 an hour is the junior end of the professional range. It can be a fair rate for scoped, supervised work. It is a warning sign when a complex build is priced at it, because complex builds priced cheap tend to be templates in disguise.",
      },
      {
        q: "How much should I charge for AI consulting?",
        a: "This page is written for buyers, but the honest seller answer is the same math in reverse: price the named deliverable, not the hours, and put the price where buyers can see it. Published prices are a constraint on the seller, which is exactly why buyers prefer them.",
      },
      {
        q: "Are AI consultants in high demand?",
        a: "Yes, and that is precisely why the title carries no quality signal by itself. Demand pulled in everyone from career specialists to weekend template installers. Judge the specific deliverables, the questions they ask about your data, and whether they publish prices.",
      },
    ],
    ctaText:
      "If you are not sure whether you need a consultant at all yet, the 30-minute call is the honest starting point.",
    ctaButtonLabel: "Book a Call",
    ctaUrl: "/book",
  },

  "ai-automation-services-pricing": {
    slug: "ai-automation-services-pricing",
    pageType: "article",
    title: "AI Automation Services Pricing: Real 2026 Numbers by Item",
    subhead: "Real 2026 numbers, item by item",
    metaDescription:
      "AI automation services pricing in 2026, item by item: what lead routing, follow-up, CRM cleanup, and reporting automations cost. With published prices.",
    url: "https://modernbizops.com/learn/ai-automation-services-pricing",
    ogImage:
      "https://modernbizops.com/og/og-learn-ai-automation-services-pricing.png",
    lastUpdated: "2026-09-01",
    h1: "How much do AI automation services cost?",
    byline: BYLINE,
    breadcrumb: [
      { name: "Home", url: "https://modernbizops.com" },
      LEARN_CRUMB,
    ...
    faq: [
      {
        q: "How much do AI automations sell for?",
        a: "At fair market prices, $1,500 to $6,500 for a named single-system automation, $7,500 and up for custom multi-system or agent work. Marketplace template installs sell for under $1,000 and are a different product: no integration, no data work, no adoption help.",
      },
      {
        q: "How much do AI automation services cost per month?",
        a: "Two different monthly numbers get blended: maintenance on systems already built runs $300 to $800 per system at market rates, and build-and-maintain retainers run $1,500 to $10,000 a month depending on scope. Ask which one a monthly quote is, and what a month actually buys.",
      },
      {
        q: "What about AI usage costs?",
        a: "Budget them per item, not per engagement. A single well-scoped business automation usually runs tens to low hundreds of dollars a month in API and tool cost, which is small enough that it almost never changes which item you should build first. Ask for the per-item number anyway, because a quote that cannot produce one has not scoped the item.",
      },
    ],
    ctaText:
      "If you would rather see the prices attached to your own systems than to market bands, start with a call.",
    ctaButtonLabel: "Book a Call",
    ctaUrl: "/book",
  },
  ...
  "ai-consultant-vs-ai-agency": {
    ...
    pageType: "article",
    title: "AI Consultant vs AI Agency: Which Should You Hire in 2026?",
    subhead: "Which should you hire in 2026?",
    metaDescription:
      "AI consultant or AI automation agency? What each costs, the four-question decision test, and the option most comparisons of the two leave out.",
    url: "https://modernbizops.com/learn/ai-consultant-vs-ai-agency",
    ogImage:
      "https://modernbizops.com/og/og-learn-ai-consultant-vs-ai-agency.png",
    lastUpdated: "2026-09-01",
    ...
    breadcrumb: [
      ...
      LEARN_CRUMB,
      {
        name: "AI consultant vs. AI automation agency",
        url: "https://modernbizops.com/learn/ai-consultant-vs-ai-agency",
      },
    ],
    faq: [
      {
        q: "What is the difference between a consultant and an agency?",
        a: "A consultant sells one senior person's judgment and hands; an agency sells a team's delivery capacity and process. The consultant's risk is capacity, the agency's risk is handoff: an impressive build nobody on your team owns.",
      },
      {
        q: "What is an AI consulting agency?",
        a: "A firm packaging both: strategy consulting on the front, a delivery team behind it. Judge it on the same four questions as anyone else, especially who owns the systems when the engagement ends, because blended firms default to staying.",
      },
      {
        q: "Which is cheaper?",
        a: "Neither, reliably. The hourly and project bands overlap almost completely at small and mid-market scope. The real cost difference shows up in month four: what maintenance costs, and whether you are renting back access to your own systems. Compare exit terms, not day rates.",
      },
    ],
    ctaText:
      "Holding two quotes and not sure either is right? Bring them to a 30-minute call and we will tell you what we see, including when the answer is not us.",
    ctaButtonLabel: "Book a Call",
    ctaUrl: "/book",
  },
};
...
const CARD_BLURBS = {
  ...
  "conversion-rate-optimization":
    "Where a B2B pipeline actually leaks, and why testing the landing page rarely moves the number.",
};
