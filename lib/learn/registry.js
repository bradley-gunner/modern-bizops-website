...
export const AUTHOR_CREDENTIAL =
  "Founder of Modern BizOps. 15 years in revenue operations, including building revenue systems at Contactually (VC-backed SaaS).";
...
const PAGES = {
  ...
  "fractional-coo-cost": {
    ...
    inlineCtas: true,
    ctaButtonLabel: "Get your Revenue Maturity Score",
    ctaUrl: "/scorecard",
  },
  ...
  "ai-for-small-business": {
    ...
    ctaButtonLabel: "See your Revenue Maturity Score",
    ctaUrl: "/scorecard",
  },
  ...
  "ai-tools-for-small-business": {
    ...
    metaDescription:
      "Not another tool list. A revenue-ops AI stack organized by the job it does, with a DIY track for tools you already pay for and the honest cost of each.",
...
export const LEARN_PAGES = Object.fromEntries(
  Object.entries(PAGES).map(([slug, entry]) => [
    slug,
    { ...entry, visual: VISUALS[slug] ?? { theme: "navy" } },
  ])
);
