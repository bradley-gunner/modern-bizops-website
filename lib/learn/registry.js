...
const PAGES = {
  ...
  "ai-tools-for-small-business": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'You will see the "30% rule" used a few ways online, usually some version of "expect AI to handle about 30% of a task and keep a human on the rest." We would not anchor on a specific number. The useful principle underneath it is real: AI is an accelerator on top of a defined process, not a replacement for one. It handles the repetitive middle of a job well and the judgment at the edges poorly. Keep a human on the definition, the exit criteria, and the exceptions. Let the AI handle the volume in between.',
      },
      {
  ...
  "reduce-customer-churn": {
    ...
    ctaText:
      "If you want help building the early-warning system and fixing the root causes instead of reading about them, book a free discovery call. We coach your team to build it, so the system stays after we are gone.",
  ...
  "payment-recovery": {
    ...
    ctaText:
      "If you want the failed-payment leak measured and the whole billing-recovery system built the right way, book a free discovery call. We coach your team to set it up, so it keeps running without us.",
    ctaButtonLabel: "Book a Free Discovery Call",
    ctaUrl: "/book",
  },
  ...
  "conversion-rate-optimization": {
    ...
    ctaText:
      "If your leads are converting worse than they should and you want to find the leak that is actually costing you, book a free discovery call. We coach your team to fix the funnel, so the improvement stays after we are gone.",
    ctaButtonLabel: "Book a Free Discovery Call",
    ctaUrl: "/book",
  },
};
