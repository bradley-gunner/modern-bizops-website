 ...
 * just hire instead.
 *
 * Every price interpolates from lib/offers.js. Never type a number in here.
 */
export const HOME_FAQ = [
  {
    q: "What does this cost?",
    a: `The Scan is free. The Audit is ${rung.audit.price} and it credits 100 percent toward whatever you build next. Builds run ${rung.builds.price} at a fixed price, set before the work starts. The Partner retainer is ${rung.partner.price}, or ${rung["partner-plus"].price} for a larger surface area. Every number is published, which is the point.`,
  },
  {
    q: `Is the ${rung.audit.price} audit money I lose if I stop there?`,
    a: "No. It credits 100 percent toward your first build or your first Partner month, as long as you start within 90 days. You also keep the heat map and the automation map either way. It is only sunk if you do nothing with it.",
  },
  {
