...
// `meet` - "here is where I would meet you" if this is your stage.
...
export const STAGES = [
  ...
  },
  {
    ...
    meet: "You are compounding. Here it is about protecting and extending the edge, focusing only on the highest-leverage plays, if any. Honestly, you may not need me.",
