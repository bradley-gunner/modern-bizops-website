...
export const HERO_VARIANTS = [
  {
    ...
    sub: "There is a path from here to a business that runs on a system, and then improves itself. It has four stages. Find where you are, and I will show you what to build next.",
  },
  {
    id: "headcount",
