import { LADDER, BUILD_PRICE_FLOOR, AUDIT_TERMS } from "./offers";
...
export const OFFER_PAGES = {
  ...
  pricing: offerPage({
    ...
    description: `Published fixed prices: free ${rung.scan.name}, ${rung.audit.price} audit with ${AUDIT_TERMS.creditPercent} credit forward, builds from ${BUILD_PRICE_FLOOR}, and partner plans from ${rung.partner.price}.`,
