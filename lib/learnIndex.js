 ...
 * this 35-character title renders at 51, inside Google's roughly 60-character
...
export const LEARN_INDEX = {
  path: "/learn",
  url: `${SITE}/learn`,
  title: "Revenue Operations Learning Library",
  description:
    "Plain-language guides on revenue operations for founder-led B2B companies: the maturity model, the Stage 1 competencies, the benchmarks, and AI at work.",
  ...
  ogAlt: "The Modern BizOps revenue operations learning library",
};
